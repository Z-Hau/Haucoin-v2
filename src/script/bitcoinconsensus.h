...
EXPORT_SYMBOL int bitcoinconsensus_verify_script( unsigned char *scriptPubKey, unsigned int scriptPubKeyLen,
                                                  unsigned char *txTo        , unsigned int txToLen,
                                                 unsigned int nIn, unsigned int flags, bitcoinconsensus_error* err);

EXPORT_SYMBOL int bitcoinconsensus_verify_script_with_amount( unsigned char *scriptPubKey, unsigned int scriptPubKeyLen, int64_t amount,
                                     unsigned char *txTo        , unsigned int txToLen,
                                    unsigned int nIn, unsigned int flags, bitcoinconsensus_error* err);
