 ...
 */
ScriptError VerifyWithFlag( CTransaction& output,  CMutableTransaction& input, int flags)
{
    ScriptError error;
 ...
 */
void BuildTxs(CMutableTransaction& spendingTx, CCoinsViewCache& coins, CMutableTransaction& creationTx,  CScript& scriptPubKey,  CScript& scriptSig,  CScriptWitness& witness)
{
