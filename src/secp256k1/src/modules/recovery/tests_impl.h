...
static int recovery_test_nonce_function(unsigned char *nonce32,  unsigned char *msg32,  unsigned char *key32,  unsigned char *algo16, void *data, unsigned int counter) {
    (void) msg32;
    (void) key32;
    (void) algo16;
    (void) data;
