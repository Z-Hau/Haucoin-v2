...
bool WinShutdownMonitor::nativeEventFilter( QByteArray &eventType, void *pMessage, long *pnResult)
{
       Q_UNUSED(eventType);
...
void WinShutdownMonitor::registerShutdownBlockReason( QString& strReason,  HWND& mainWinId)
{
