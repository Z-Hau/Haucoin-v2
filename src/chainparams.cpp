...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 48000; // 800 block (difficulty readjust interval)
        consensus.nPowTargetSpacing = 60; // 1 minute (block time)
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 760; // 95% of 800
        consensus.nMinerConfirmationWindow = 800; // nPowTargetTimespan / nPowTargetSpacing
