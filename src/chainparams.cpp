...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 90000; // 1500 block (difficulty readjust interval)
        consensus.nPowTargetSpacing = 60; // 1 minute (block time)
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 9142550; // 95% of 1500
        consensus.nMinerConfirmationWindow = 1500; // nPowTargetTimespan / nPowTargetSpacing
