...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 600000; // 10000 block (difficulty readjust interval)
        consensus.nPowTargetSpacing = 60; // 1 minute (block time)
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 9500; // 95% of 10000
        consensus.nMinerConfirmationWindow = 10000; // nPowTargetTimespan / nPowTargetSpacing
