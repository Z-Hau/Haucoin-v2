 ...
 * database.
 *
 * CBlock(hash=000000000019d6, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=4a5e1e, nTime=1552451141, nBits=1d00ffff, nNonce=655122388, vtx=1)
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x000000000ded045d1bf708373e732fb5562303e876612126b7e9ced983e3c7a4");
        consensus.BIP65Height = 0; // 000000000000000004c2b624ed5d7756c508d90fd0da2c7c679febfa6c4735f0
        consensus.BIP66Height = 0; // 00000000000000000379eaa19dce8c9b722d46ae6a57c2f1a988119488b50931
        consensus.powLimit = uint256S("0x00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 2/3 * 60 * 60; // 40 minute
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1552451141; // December 31, 2008

        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 0; // May 1st, 2016
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1552451141; // May 1st, 2017

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 0; // November 15th, 2016.
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1552451141; // November 15th, 2017.
        ...
        genesis = CreateGenesisBlock(1552451141, 655122388, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000000ded045d1bf708373e732fb5562303e876612126b7e9ced983e3c7a4"));
        assert(genesis.hashMerkleRoot == uint256S("0xf47eb4bd8f7d1966f6789bd165b3c378d4027e9ac585d209acc47413a64c6b68"));
        ...
        chainTxData = ChainTxData{
            ...
            1552451141, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1552451141; // May 1st 2017
