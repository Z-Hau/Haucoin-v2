...
{
    const char* pszTimestamp = "NY Times 13/Mar/2019 Boeing Flights Grounded Across the Globe, but Not in the U.S.";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 600; // 40 minute (difficulty readjust interval)
        consensus.nPowTargetSpacing = 60; // 1 minute (block time)
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 9; // 95% of 40
        ...
        checkpointData = {
            {
                {141432,uint256S("00000005906faa0b4951b2a334b30b5230ce1468d71c913cb59a7c9dc26f7c35")},
            }
        };

        chainTxData = ChainTxData{
            // Data as of block 0000000000000000002d6cca6761c99b3c2e936f9a0e304b7c7651a993f461de (height 506081).
            1565056730, // * UNIX timestamp of last known number of transactions
            141432,  // * total number of transactions between genesis and that timestamp
