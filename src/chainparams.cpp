...
static CBlock CreateGenesisBlock( char* pszTimestamp,  CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion,  CAmount& genesisReward)
{
    CMutableTransaction txNew;
    txNew.nVersion = 1;
    txNew.vin.resize(1);
    txNew.vout.resize(1);
    txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << std::vector<unsigned char>(( unsigned char*)pszTimestamp, ( unsigned char*)pszTimestamp + strlen(pszTimestamp));
 ...
 * database.
 *
 * CBlock(hash=000000000019d6, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=4a5e1e, nTime=1552533118, nBits=1d00ffff, nNonce=554031, vtx=1)
 *   CTransaction(hash=4a5e1e, ver=1, vin.size=1, vout.size=1, nLockTime=0)
 *     CTxIn(COutPoint(000000, -1), coinbase 04ffff001d0104455468652054696d65732030332f4a616e2f32303039204368616e63656c6c6f72206f6e206272696e6b206f66207365636f6e64206261696c6f757420666f722062616e6b73)
 *     CTxOut(nValue=50.00000000, scriptPubKey=0x5F1DF16B2B704C8A578D0B)
 *   vMerkleTree: 4a5e1e
 */
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion,  CAmount& genesisReward)
{
     char* pszTimestamp = "NY Times 13/Mar/2019 Boeing Flights Grounded Across the Globe, but Not in the U.S.";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x000001e41add40a83c07d1282a695836e0a10e85b92abbc9551d349c2c879e01");
        consensus.BIP65Height = 0; // 000000000000000004c2b624ed5d7756c508d90fd0da2c7c679febfa6c4735f0
        consensus.BIP66Height = 0; // 00000000000000000379eaa19dce8c9b722d46ae6a57c2f1a988119488b50931
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 1200000; // 20000 block (difficulty readjust interval)
        consensus.nPowTargetSpacing = 60; // 1 minute (block time)
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 19000 ; // 95% of 20000
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1552533118; // December 31, 2008

        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1552533118; // May 1st, 2016
        ...
        assert(genesis.hashMerkleRoot == uint256S("0xc9f5104fd789a532c6245f14f15176ed44ff071997d8d164a995f9e921371d83"));
...
public:
    CTestNetParams() {
        ...
        consensus.nPowTargetTimespan = 600; // two weeks
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1552533118; // May 1st, 2017

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 0; // May 1st 2016
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1552533118; // May 1st 2017
...
void SelectParams( std::string& network)
{
